  ...
  <div className="xl:container m-auto px-6 text-gray-600 md:px-12 xl:px-16">
    <div className="lg:yellow-50 shark:lg:bg-sharker lg:p-16 rounded-[4rem] space-y-6 md:flex flex-row-reverse md:gap-6 justify-center md:space-y-0 lg:items-center">
      ...
      <div className="md:7/12 lg:w-1/2">
        ...
        <div className="divide-y space-y-4 divide-gray-100 shark:divide-gray-800">
          <div className="mt-8 flex gap-4 md:items-center">
            <div className="w-12 h-12 flex gap-4 rounded-full bg-indigo-100 shark:bg-indigo-900/20">
              <svg
