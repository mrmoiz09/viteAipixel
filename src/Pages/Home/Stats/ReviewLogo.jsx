export default function ReviewLogo() {
  return (
    <>
      ...
      {/*  */}
      <section className="bg-gray-50 shark:bg-gray-900">
        ...
        <>
          ...
          <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <p className="mt-1 text-2xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-md text-center my-4">
              Defining Norms Outperforming Projections.
            </p>

            {/* Title */}
            <div className="w-2/3 sm:w-1/2 lg:w-1/3 mx-auto text-center mb-6">
              <h2 className="text-gray-600 shark:text-gray-400">
              ...
              >
                <g clipPath="url(#a)">
                  ...
                  <path
                    ...
                    fill="currentColor"
                    className="fill-white shark:fill-slate-900"
                  />
                </g>
              </svg>
            </div>
