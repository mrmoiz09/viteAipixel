    ...
    <>
      <>
        ...
        <div className="overflow-hidden">
          <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20 mt-[6rem]">
            <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
              ...
              >
                ...
                <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight shark:text-gray-200">
                  Turn online ideas ! into{" "}
