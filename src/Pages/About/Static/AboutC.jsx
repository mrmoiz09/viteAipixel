        ...
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          <div className="aspect-w-16 aspect-h-7">
            <img
              ...
              src="https://img.freepik.com/premium-photo/mission-make-business-even-better-high-angle-shot-group-businesspeople-having-meeting-modern-office_590464-26576.jpg?w=740"
          ...
          <div className="mt-5 lg:mt-16 grid lg:grid-cols-3 gap-8 lg:gap-12">
            <div className="lg:col-span-1">
              <h2 className="font-bold text-2xl md:text-3xl text-gray-800 shark:text-gray-200">
            ...
            <div className="lg:col-span-2">
              <div className="grid sm:grid-cols-2 gap-8 md:gap-12">
                ...
                <div className="flex gap-x-5">
                  <svg
                    className="flex-shrink-0 mt-1 w-6 h-6 text-blue-600 shark:text-blue-500"
                  ...
                  <div className="grow">
                    <h3 className="text-lg font-semibold text-gray-800 shark:text-white">
                      Creative minds
                    </h3>
                    <p className="mt-1 text-gray-600 shark:text-gray-400">
