...
export default function Worka() {
  ...
  <div className="overflow-hidden">
    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20 mt-[3rem]">
      <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
        ...
        className="text-center">
          <p className="text-xs font-semibold text-gray-500 tracking-wide uppercase mb-3 shark:text-gray-200">
            Small business solutions
          </p>
          <h1 className="text-2xl text-gray-800 font-bold sm:text-5xl lg:text-4xl lg:leading-tight shark:text-gray-200">
          Showcasing Our Stellar Portfolio
            <span className="text-blue-500">Highlighting Key Collaborations</span>
          </h1>
        </motion.div>
        ...
        <div className="sm:flex sm:justify-center sm:items-center text-center sm:text-left">
          <div className="flex-shrink-0 pb-5 sm:flex sm:pb-0 sm:pr-5">
            ...
            <div className="flex justify-center -space-x-3">
              <img
                className="inline-block h-8 w-8 rounded-full ring-2 ring-white shark:ring-gray-800"
          ...
          <div className="pt-5 sm:pt-0 sm:pl-5">
            <div className="text-lg font-semibold text-gray-800 shark:text-gray-200">
              Trusted Clients
            </div>
        ...
        >
          ...
          >
            <path
              ...
              fill="currentColor"
              className="fill-gray-800 shark:fill-white"
            />
            <path
